...
FreeImage_Free($newdib);
$newdib = FreeImage_Dither($dib, FID_BAYER16x16);
FreeImage_Save($newdib, dirname(__FILE__) . "/php_dither_bayer16x16.jpg", 0);
FreeImage_Free($newdib);
...
$fi->Free($newdib);
$newdib = $fi->Dither($dib, FID_BAYER16x16);
$fi->Save($newdib, dirname(__FILE__) . "/php_dither_bayer16x16.jpg", 0);
$fi->Free($newdib);
